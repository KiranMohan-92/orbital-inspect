...
export AUTH_ENABLED="${AUTH_ENABLED:-${ORBITAL_INSPECT_E2E_AUTH_ENABLED:-true}}"
export JWT_SECRET="${JWT_SECRET:-${ORBITAL_INSPECT_E2E_JWT_SECRET:-orbital-inspect-e2e-jwt-secret-2026}}"
export E2E_TEST_MODE="${E2E_TEST_MODE:-true}"
export E2E_ORG_ID="${E2E_ORG_ID:-${ORBITAL_INSPECT_E2E_ORG_ID:-org-e2e}}"
export E2E_ORG_NAME="${E2E_ORG_NAME:-${ORBITAL_INSPECT_E2E_ORG_NAME:-Orbital Inspect E2E}}"
export ANALYSIS_RATE_LIMIT_PER_HOUR="${ANALYSIS_RATE_LIMIT_PER_HOUR:-${ORBITAL_INSPECT_E2E_ANALYSIS_RATE_LIMIT_PER_HOUR:-500}}"
export REPORT_RATE_LIMIT_PER_HOUR="${REPORT_RATE_LIMIT_PER_HOUR:-${ORBITAL_INSPECT_E2E_REPORT_RATE_LIMIT_PER_HOUR:-500}}"
