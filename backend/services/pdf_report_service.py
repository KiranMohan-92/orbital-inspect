"""
Internal detailed analysis report generator (not the customer Evidence Pack).

Customer-facing buyer artifacts are generated by evidence_pack_service.
This module still renders a long-form HTML report for operators. It is a
public risk screen, not an underwriting or NASA inspection certificate.
...
def generate_html_report(
    ...
    """Generate a long-form HTML analysis report (internal / operator)."""
